...
-- Dimension Table 6: SKU Masters (Encarta)
...
SELECT
    ...
    sm.node_id AS sku_node_id,
    COALESCE(sm.category, '') AS sku_category,
    COALESCE(sm.product, '') AS sku_product,
    COALESCE(sm.product_id, '') AS sku_product_id,
    COALESCE(sm.category_group, '') AS sku_category_group,
    COALESCE(sm.sub_brand, '') AS sku_sub_brand,
    COALESCE(sm.brand, '') AS sku_brand,
    COALESCE(sm.code, '') AS sku_code,
    COALESCE(sm.name, '') AS sku_name,
    COALESCE(sm.short_description, '') AS sku_short_description,
    COALESCE(sm.description, '') AS sku_description,
    COALESCE(sm.fulfillment_type, '') AS sku_fulfillment_type,
    COALESCE(sm.inventory_type, '') AS sku_inventory_type,
    COALESCE(sm.shelf_life, 0) AS sku_shelf_life,
    COALESCE(sm.tag1, '') AS sku_tag1,
    COALESCE(sm.tag2, '') AS sku_tag2,
    COALESCE(sm.tag3, '') AS sku_tag3,
    COALESCE(sm.tag4, '') AS sku_tag4,
    COALESCE(sm.tag5, '') AS sku_tag5,
    COALESCE(sm.handling_unit_type, '') AS sku_handling_unit_type,
    COALESCE(sm.cases_per_layer, 0) AS sku_cases_per_layer,
    COALESCE(sm.layers, 0) AS sku_layers,
    COALESCE(sm.l0_units, 0) AS sku_l0_units,
    COALESCE(sm.l1_units, 0) AS sku_l1_units,
    COALESCE(sm.l2_units, 0) AS sku_l2_units,
    COALESCE(sm.l3_units, 0) AS sku_l3_units,
    COALESCE(sm.l0_name, '') AS sku_l0_name,
    COALESCE(sm.l0_weight, 0.0) AS sku_l0_weight,
    COALESCE(sm.l0_volume, 0.0) AS sku_l0_volume,
    COALESCE(sm.l0_package_type, '') AS sku_l0_package_type,
    COALESCE(sm.l0_length, 0.0) AS sku_l0_length,
    COALESCE(sm.l0_width, 0.0) AS sku_l0_width,
    COALESCE(sm.l0_height, 0.0) AS sku_l0_height,
    COALESCE(sm.l0_packing_efficiency, 0.0) AS sku_l0_packing_efficiency,
    COALESCE(sm.l1_name, '') AS sku_l1_name,
    COALESCE(sm.l1_weight, 0.0) AS sku_l1_weight,
    COALESCE(sm.l1_volume, 0.0) AS sku_l1_volume,
    COALESCE(sm.l1_package_type, '') AS sku_l1_package_type,
    COALESCE(sm.l1_length, 0.0) AS sku_l1_length,
    COALESCE(sm.l1_width, 0.0) AS sku_l1_width,
    COALESCE(sm.l1_height, 0.0) AS sku_l1_height,
    COALESCE(sm.l1_packing_efficiency, 0.0) AS sku_l1_packing_efficiency,
    COALESCE(sm.l2_name, '') AS sku_l2_name,
    COALESCE(sm.l2_weight, 0.0) AS sku_l2_weight,
    COALESCE(sm.l2_volume, 0.0) AS sku_l2_volume,
    COALESCE(sm.l2_package_type, '') AS sku_l2_package_type,
    COALESCE(sm.l2_length, 0.0) AS sku_l2_length,
    COALESCE(sm.l2_width, 0.0) AS sku_l2_width,
    COALESCE(sm.l2_height, 0.0) AS sku_l2_height,
    COALESCE(sm.l2_packing_efficiency, 0.0) AS sku_l2_packing_efficiency,
    COALESCE(sm.l3_name, '') AS sku_l3_name,
    COALESCE(sm.l3_weight, 0.0) AS sku_l3_weight,
    COALESCE(sm.l3_volume, 0.0) AS sku_l3_volume,
    COALESCE(sm.l3_package_type, '') AS sku_l3_package_type,
    COALESCE(sm.l3_length, 0.0) AS sku_l3_length,
    COALESCE(sm.l3_width, 0.0) AS sku_l3_width,
    COALESCE(sm.l3_height, 0.0) AS sku_l3_height,
    COALESCE(sm.l3_packing_efficiency, 0.0) AS sku_l3_packing_efficiency,
    sm.active AS sku_active,
    COALESCE(sm.classifications, '') AS sku_classifications,
    COALESCE(sm.product_classifications, '') AS sku_product_classifications
