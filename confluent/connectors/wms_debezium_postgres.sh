...
curl -X PUT http://localhost:8083/connectors/postgres-source/config -H "Content-Type: application/json" \
-d '{
      ...
      "key.converter.basic.auth.user.info": "'"$CONNECT_VALUE_CONVERTER_SCHEMA_REGISTRY_BASIC_AUTH_USER_INFO"'",
      "value.converter.basic.auth.user.info": "'"$CONNECT_VALUE_CONVERTER_SCHEMA_REGISTRY_BASIC_AUTH_USER_INFO"'",
