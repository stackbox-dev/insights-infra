...
curl -X PUT http://localhost:8083/connectors/clickhouse-connect-${TOPIC_PREFIX}-wms-workstation/config \
...
-d  '{
      ...
      "errors.deadletterqueue.topic.name": "dlq-wms-clickhouse-workstation",
