-- ClickHouse table for WMS IRA Bin Items
-- Dimension table for IRA Bin Items information
-- Source: samadhan_prod.wms.public.ira_bin_items
...
(
    ...
    huSameBinBeforeIRA String DEFAULT '',
