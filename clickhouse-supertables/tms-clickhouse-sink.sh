...
curl -X PUT http://localhost:8083/connectors/clickhouse-connect-${TOPIC_PREFIX}-tms/config \
...
-d  '{
      ...
      "errors.deadletterqueue.topic.name": "dlq-tms-clickhouse",
