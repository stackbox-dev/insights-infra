...
curl -X PUT http://localhost:8083/connectors/clickhouse-connect-${TOPIC_PREFIX}-backbone/config \
...
-d  '{
      ...
      "errors.deadletterqueue.topic.name": "dlq-backbone-clickhouse",
